    ...
    <div>
      ...
      <div className={classes.father}>
        ...
        <p>
          ...
          یک بلیط واقعی در بین بلیط های شرکت داده شده در قرعه کشی وجود داشته
          باشد. به این معنی که اگر 10 سکه شانس دارید حتما حساب کاربری شما باید
          حداقل یک عدد پرفکت مانی داشته باشد تا بتوانید در زمان شرکت دادن آن یک
          عدد پرفکت مانی در قرعه کشی از 10 سکه شانس خود، همراه آن استفاده کنید.
        </p>
